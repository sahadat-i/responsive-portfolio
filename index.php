...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="#" class="nav__logo">Sahadat</a>
            <div class="nav__menu">
                <ul class="nav__list">
                    <li class="nav__item">
    ...
    <main class="main">
        ...
        <section class="home section" id="home">
            <div class="home__container container grid">
                ...
                <div class="home__social">
                    <a href="https://www.linkedin.com/" target="_blank"class="home__sosial-link">
                        <i class='bx bxl-linkedin-square'></i>
                    </a>
                    <a href="https://github.com/" target="_blank" class="home__sosial-link">
                        <i class='bx bxl-gitlab'></i>
                    </a>
                    <a href="https://dribbble.com/" target="_blank" class="home__sosial-link">
        ...
        <section class="work section" id="work">
            ...
            <div class="work__filters">
                ...
                <span class="work__item" data-filter=".movile">Movile</span>
            ...
            <div class="work__container container grid">
                ...
                <div class="work__card mix movile">
        ...
        <section class="contact section" id="contact">
            ...
            <div class="contact__container contrainer grid">
                <div class="contact__content">
                    ...
                    <div class="contact__info">
                        <div class="contact__card">
                            ...
                            <span class="contact__card-data">islamsyahadad@gmail.com</span>
                            <a href="mailto:islamsyahadad@gmail.com" target="_blank"class="contact__button">
                                Write me 
                        ...
                        <div class="contact__card">
                            ...
                            <span class="contact__card-data">085802269603</span>
                            <a href="https://api.whatsapp.com/send?phone=628802269603&text=I%20want %20to%20discuss %20project %20collaboration%20with%20you." target="_blank"class="contact__button">
                                Write me 
                                <i class="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
                        <div class="contact__card">
                            <i class='bx bxl-messenger contact__card-icon'></i>                            <h3 class="contact__card-title">
                                Messenger
                            </h3>
                            <span class="contact__card-data">sahadat</span>
                ...
                <div class="contact__content">
                    ...
                    <form action="" class="contact__form">
                        ...
                        <div class="contact__form-div">
                            ...
                            <input type="email" placeholder="Inser Your Email" class="contact__form-input">
                        </div>
    ...
    <footer class="footer">
        <div class="footer__container container"></div>
            <h1 class="footer__title">Sahadat</h1>
            <ul class="footer__list">
                <li>
                    <a href="#about" class="footer">About</a>
                </li>
                <li>
                    <a href="#work" class="footer">Project</a>
                </li>
                <li>
                    <a href="#testimonial" class="footer">Testimonial</a>
                </li>
            </ul>
            ...
            <span class="footer__copy">&#169; Sahadat. All rigths reserved</span>
        </div>
    </footer>
